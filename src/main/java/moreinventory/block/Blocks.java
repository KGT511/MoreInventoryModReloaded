...
public final class Blocks {
    ...
    private static <T extends Block> RegistryObject<T> register(String name, Function<BlockBehaviour.Properties, T> block, Supplier<BlockBehaviour.Properties> blockProperties) {
    ...
    private static <T extends Block> RegistryObject<T> register(
        ...
        var ret = BLOCKS.register(name, () -> block.apply(blockProperties.get().setId(BLOCKS.key(name))));
        itemProperties = Objects.isNull(itemProperties) ? (() -> new Item.Properties().useBlockDescriptionPrefix()) : itemProperties;
